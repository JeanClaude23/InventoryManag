  ...
  <div id="showResult" style="font-family: monospace;"></div>
    ...
    <form id="signIn">
      ...
      <div class="row">
        <!-- /.col -->
        <div class="col-xs-12">
            <button type="submit" class="btn btn-primary btn-block btn-flat" style="font-family: cursive;">Sign In</button>
        </div>
        <!-- /.col -->
      </div>
    </form>

  <center><a href="register.jsp" class="text-center font-monospace" style="font-family: cursive;">Register New Membership</a></center>
     ...
     $.ajax({
         ...
         success: function(data){
        	 ...
        	 if(result === 'login'){
            	 ...
            	 $('#showResult').html(data).fadeIn().delay(1000).fadeOut();
        	 }
         },
         error: function(err){
